...
function Tycoon:Rebirth()
	...
	local dataRoot = player:FindFirstChild("Data")
	local inventoryPets = dataRoot and dataRoot:FindFirstChild("Pets")
	if inventoryPets then
		inventoryPets:ClearAllChildren()
	end
